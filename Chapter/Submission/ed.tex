...
\begin{figure}
\begin{center}
	\includegraphics[width=75mm]{figures/wcst.ps}
                                                                
\textcolor{white}{\\--------------------------------\\}

	\includegraphics[width=75mm]{figures/stroop.ps}
\end{center}
...
\begin{figure}[t]
\begin{center}
	\includegraphics[width=75mm]{figures/stroop_devel.eps}
\end{center}
...
\begin{figure}[t]
\begin{center}
	\includegraphics[width=75mm]{figures/wcst_devel_persev.eps}
\end{center}
